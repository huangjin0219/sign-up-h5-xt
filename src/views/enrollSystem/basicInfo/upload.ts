// 压缩图片
export function handleCompressImg(file: any) {
  if (/^image/.test(file.type)) {
    return new Promise((resolve, reject) => {
      ...
      reader.onloadend = function (e) {
        ...
        img.onload = function () {
          return resolve(dataURLtoFile(compress(img), file.name))
        }
      }
    })
  }
...
export function compress(img: any) {
  // 压缩操作
